...
if (isset($_POST['register'])) {
    try {
        ...
        if (empty($firstName) && empty($lastName) && empty($contactNumber) && empty($email) && empty($username) && empty($password)) {
            echo "
            <script>
                alert('Login Failed, Please fill the empty fields');
            ...
            ";
                ...
                if (empty($nameExist)) {
                    ...
                    //Recipients
                    $mail->setFrom('noedurog@gmail.com', 'Durog Noe');
                    $mail->addAddress($email);   
                    $mail->addReplyTo('noedurog@gmail.com', 'Durog Noe'); 
                    ...
                    <script>
                        ...
                        window.location.href = 'http://localhost/group/verification.php';
                    </script>
                    ";
